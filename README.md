# Nile Delta Archaeological Database
...
Available in Durham eTheses --- Download it from here ->

http://etheses.dur.ac.uk/14524/7/Hinojosa-Balino-PhDthesis-vol1.pdf
...
###### The default SQL is configured to work with an user called "postgres", which is also the superuser. This database was created for reproducibility purposes. Should you require a new working environment with a specific username, you need to grant user privileges to any other user but postgres. To find out more:
